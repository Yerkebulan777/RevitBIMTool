...
{
    internal static class MEPHelper
    {
        private static List<Element> GetPipesAndDucts(Document doc)
        {
            List<Element> elementsList = new List<Element>(100);
        ...
        private static double GetPipeWallThickness(Element pipe)
        {
        ...
        private static double GetDuctWallThickness(Element duct)
        {
